...
export class HttpServer {
    ...
    private readonly startingPrompt: string;
    ...
    constructor() {
        ...
        this.startingPrompt = `You are now an exceptional code documentation tool created by the best programmers around the world. You are specialized in typescript and can understand even the context of the code provided. From now on, your task is to comment on incoming code snippets. 
    ...
    async handleCodeSnippet(request: HTTPRequest) {
        ...
        const startingPrompt = this.startingPrompt;
