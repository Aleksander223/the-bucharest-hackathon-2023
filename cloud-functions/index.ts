...
export class HttpServer {
    ...
    constructor() {
        ...
        this.startingPromptSnippet = `You are now a cutting-edge code documentation tool. You are specialized in typescript and can understand even the context of the code provided. From now on, your task is to comment incoming code snippets. 
        ...
        Please add JSDOC comments if the provided code snippet is a valid function or class, otherwise (for instance if the provided code snippet is not a function or class definition) then do not add the JSDOC comment.
        You will keep the same formatting of the source code as the input. This is mandatory.
        `
